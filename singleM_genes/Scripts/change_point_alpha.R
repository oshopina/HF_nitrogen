...
best_cluster = openxlsx::read.xlsx('singleM_genes/Results/best_cluster_alpha.xlsx')
...
genes = list(anfH = GSV_rarefied_gsvtables73$anfH,
                     ...
                     hzsA = GSV_rarefied_gsvtables69$hzsA,
                     hzsB = GSV_rarefied_gsvtables71$hzsB,
                     hzsC = GSV_rarefied_gsvtables74$hzsC,
                     napA = GSV_rarefied_gsvtables51$napA,
                     ...
                     narI = GSV_rarefied_gsvtables91$narI,
                     ...
                     nirB = GSV_rarefied_gsvtables87$nirB,
                     nirD = GSV_rarefied_gsvtables97$nirD,
                     nirK = GSV_rarefied_gsvtables68$nirK,
                     nod = GSV_rarefied_gsvtables67$nod,
                     norB = GSV_rarefied_gsvtables67$norB,
                     norC = GSV_rarefied_gsvtables94$norC,
                     nosZ = GSV_rarefied_gsvtables96$nosZ,
                     NR = GSV_rarefied_gsvtables95$NR,
                     nrfA = GSV_rarefied_gsvtables65$nrfA,
                     nrfB = GSV_rarefied_gsvtables95$nrfB,
                     nrfC = GSV_rarefied_gsvtables52$nrfC,
                     nrfD = GSV_rarefied_gsvtables81$nrfD,
                     nrfH = GSV_rarefied_gsvtables96$nrfH,
                     ureA = GSV_rarefied_gsvtables98$ureA,
                     ureB = GSV_rarefied_gsvtables87$ureB,
                     ureC = GSV_rarefied_gsvtables89$ureC,
                     ureD = GSV_rarefied_gsvtables60$ureD,
                     ureE = GSV_rarefied_gsvtables75$ureE,
                     ureF = GSV_rarefied_gsvtables75$ureF,
                     ureG = GSV_rarefied_gsvtables86$ureG,
...
shannon = data.frame(anfH = GSV_alpha_div_cluster73$C_shannon$anfH,
                     ...
                     hzsA = GSV_alpha_div_cluster69$C_shannon$hzsA,
                     hzsB = GSV_alpha_div_cluster71$C_shannon$hzsB,
                     hzsC = GSV_alpha_div_cluster74$C_shannon$hzsC,
                     napA = GSV_alpha_div_cluster51$C_shannon$napA,
                     ...
                     narI = GSV_alpha_div_cluster91$C_shannon$narI,
                     ...
                     nirB = GSV_alpha_div_cluster87$C_shannon$nirB,
                     nirD = GSV_alpha_div_cluster97$C_shannon$nirD,
                     nirK = GSV_alpha_div_cluster68$C_shannon$nirK,
                     nod = GSV_alpha_div_cluster67$C_shannon$nod,
                     norB = GSV_alpha_div_cluster67$C_shannon$norB,
                     norC = GSV_alpha_div_cluster94$C_shannon$norC,
                     nosZ = GSV_alpha_div_cluster96$C_shannon$nosZ,
                     NR = GSV_alpha_div_cluster95$C_shannon$NR,
                     nrfA = GSV_alpha_div_cluster65$C_shannon$nrfA,
                     nrfB = GSV_alpha_div_cluster95$C_shannon$nrfB,
                     nrfC = GSV_alpha_div_cluster52$C_shannon$nrfC,
                     nrfD = GSV_alpha_div_cluster81$C_shannon$nrfD,
                     nrfH = GSV_alpha_div_cluster96$C_shannon$nrfH,
                     ureA = GSV_alpha_div_cluster98$C_shannon$ureA,
                     ...
                     ureE = GSV_alpha_div_cluster75$C_shannon$ureE,
                     ureF = GSV_alpha_div_cluster75$C_shannon$ureF,
                     ureG = GSV_alpha_div_cluster86$C_shannon$ureG,
